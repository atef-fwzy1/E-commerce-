...
async function HandelSubmit(e){
  ...
  try{
    ...
    setloader(true)
   await axios.post("https://e-commerce-backend-production-c659.up.railway.app/api/login",
    {
      email:form.email,
           ...
           <div className='optionLogin'>
              <div className='cont_logo'>
               ...
               <div className='google'>
                   <a href={'https://e-commerce-backend-production-c659.up.railway.app/login-google'}>
